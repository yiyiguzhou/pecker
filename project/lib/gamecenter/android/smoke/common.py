...
class Common(ProducerDevice):
    ...
    def __init__(self, target, ele_conf_name='android'):
        ...
        self._thread_ad = None
        self._start_thread_flag = False

    def into_game_center(self, new_game="新游", poker=None):
        """
        从推荐页面中基线进入游戏中心
        Args:
            new_game: 游戏中心新游元素
    ...
    def game_install(self, game_name: str, open_game=False, confirm_guide=True, click_last_installed=True, close_game=True, button_xpath=None, button_id=None, timeout=240):
        """
