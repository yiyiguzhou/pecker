...
class  Mainland(Android):
    ...
    def Other_login_retrieve_password_mobile(self,phone,title):
        """
    ...
    def Other_login_retrieve_password_email(self, email):
        """
    ...
    def customer(self):
        ...
        """
        try:
            self.device.find_element_by_id('com.iqiyigame.sdk:id/tv_custom_service', timeout=5).click()
            time.sleep(5)
