...
"""
File Name:      PokerTopRecommendBubbleCircle
Author:         zhangwei04
...
class PokerTopRecommendBubbleCircle(TestsuiteNormal):
    """
    预置条件：无
    """
    def setup(self):
        self.desc = "棋牌-顶部推荐-游戏社区入口"
    ...
    def test(self):
        ...
        assert_true(DUT.PokerPage.check_top_recommend_bubble_circle(), "游戏社区入口", target=DUT)
