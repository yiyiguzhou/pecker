...
class MyInfoBookedUI(TestsuiteMyInfo):
    """
    预置条件：无
    """
    def setup(self):
        self.desc = "个人中心-已预约UI"
    ...
    def test(self):
        ...
        assert_true(DUT.MyInfoPage.check_tab_ui(tab_name=self.data.tab_name, game_name=self.data.game_name), "检测已预约tabUI", target=DUT)
