...
class ClassifyTabUI(TestsuiteNormal):
    """
    预置条件：无
    """
    def setup(self):
        self.desc = "分类-类别标签页UI"
    ...
    def test(self):
        ...
        assert_true(DUT.ClassifyPage.check_tab_ui(self.data.tab_name, game_name=self.data.game_name), "检测标签UI", target=DUT)
