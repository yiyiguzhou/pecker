...
class H5GameExitDLApp(TestsuiteNormal):
    """
    预置条件：无
    """
    def setup(self):
        self.desc = "H5游戏-退出-下载微端"
    ...
    def test(self):
        ...
        assert_true(DUT.GamePage.click_h5_exit_download_wd(), "点击下载微端", target=DUT)
        assert_true(DUT.GamePage.check_h5_exit_download_app_toast(), "检测已下载toast", target=DUT)
