...
class H5GameExitMoreGame(TestsuiteNormal):
    """
    预置条件：无
    """
    def setup(self):
        self.desc = "H5游戏-退出-更多游戏"
    ...
    def test(self):
        ...
        assert_true(DUT.GamePage.click_h5_exit_more_game(), "点击退出页更多游戏", target=DUT)
