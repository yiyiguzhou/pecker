...
class GDBubbleCircleUI(TestsuiteNormal):
    """
    预置条件：游戏有福利和游戏圈
    """
    def setup(self):
        self.desc = "游戏详情-游戏圈UI"
    ...
    def test(self):
        ...
        assert_true(DUT.GameDetailPage.check_bubble_circle_ui(), "检测游戏圈TabUI", target=DUT)
