...
"""
File Name:      GDBubbleCircleUploadVideo
Author:         zhangwei04
...
class GDBubbleCircleUploadVideo(TestsuiteNormal):
    """
    预置条件：游戏详情页有福利和游戏圈
    """
    def setup(self):
        self.desc = "游戏详情-游戏圈-上传视频"
    ...
    def test(self):
        ...
        assert_true(DUT.GameDetailPage.bubble_circle_share(self.data.title, self.data.comment, type='video'), "游戏圈上传视频", target=DUT)
