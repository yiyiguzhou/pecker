...
"""
File Name:      GDBubbleCircleGotoPublish
Author:         zhangwei04
...
class GDBubbleCircleGotoPublish(TestsuiteNormal):
    """
    预置条件：游戏详情页有福利和游戏圈
    """
    def setup(self):
        self.desc = "游戏详情-游戏圈-发布"
    ...
    def test(self):
        ...
        assert_true(DUT.GameDetailPage.bubble_circle_share(self.data.title, self.data.comment), "游戏圈发布信息", target=DUT)
