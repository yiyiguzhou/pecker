...
class GDBubbleCircleSwipe(TestsuiteNormal):
    """
    预置条件：游戏详情页有福利和游戏圈
    """
    def setup(self):
        self.desc = "游戏详情-游戏圈-滑动发布icon显示"
    ...
    def test(self):
        ...
        assert_true(DUT.GameDetailPage.swipe_check_send_icon(), "游戏圈滑动查看图标显示", target=DUT)
