...
"""
File Name:      UserFollowIntoLiteRoom
Author:         zhangwei04
...
class UserFollowIntoLiteRoom(TestsuiteNormal):
    def setup(self):
        self.desc = "个人中心-我的关注-进入直播间"
    ...
    def test(self):
        ...
        assert_true(DUT.UserPage.click_tab("我的关注"), desc='进入我的关注Tab', target=DUT)
        assert_true(DUT.UserPage.check_follow_ui(), desc='检测我的关注页面', target=DUT)
