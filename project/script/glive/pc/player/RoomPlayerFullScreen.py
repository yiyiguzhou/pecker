...
"""
File Name:      RoomPlayerFullScreen
Author:         zhangwei04
...
class RoomPlayerFullScreen(TestsuiteNormal):
    def setup(self):
        self.desc = "直播间-播放器-全屏"
    ...
    def test(self):
        ...
        assert_true(DUT.RoomPlayer.full_screen(), desc="打开全屏", target=DUT)
        time.sleep(2)
        assert_true(DUT.RoomPlayer.exit_full_screen(), desc="退出全屏", target=DUT)
