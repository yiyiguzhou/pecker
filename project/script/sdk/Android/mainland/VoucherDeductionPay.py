"""
File Name:      VoucherDeductionPay.py
...
class VoucherDeductionPay(TestsuiteNormal):
    """
        用例描述：
        预制条件：
        """
    ...
    def test(self):
        ...
        time.sleep(5)
        assert_true(DUT.Mainland.Voucher_DiscountWechatPay(self.data.num,self.data.name), "成功进入支付页面", target=DUT)
        time.sleep(5)
