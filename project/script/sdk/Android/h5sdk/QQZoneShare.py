...
class QQZoneShare(TestsuiteNormal):
    """
        用例描述：QQ空间分享
        预制条件：无
        """
    ...
    def test(self):
        ...
        assert_true(DUT.H5sdk.qqzone_share(self.data.qq_account,self.data.qq_password), "QQ空间分享成功", target=DUT)
